...
Fix: The title of
<fendo/websites/trunk/src/pages/eo.kajero.2007.11.24.fs>.
is not displayed with the proper style:

----
title es(( // África con un par // )) (Afriko je du…)
----

The resulting HTML is the following, perhaps because of an unupdated
flag because of a previous unbalanced markup:

----
<h1><span lang="es"></em> África con un par <em></span> (Afriko je du…)</h1>
----
