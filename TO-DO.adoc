...
- Make versions of the "dloc", "uloc" and "oloc" addons to list the
  pages in reverse order.

== 2022-03-17

Fix: When the "title" metadatum is empty and other page needs it, the
process halts with "uncaught exception: Invalid memory address". Note:
The page with the empty title can be built normally.
