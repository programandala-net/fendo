...
| Possible link with code:         | `[[ "URL" "TXT" attr=" ATTR" ]]`
...
Also, the HTML attributes could be defined as recognizers prefixes, in order
to allow `attr="ATTR"`.
...
- Replace "See:" with "See also:" in the documentation.
