...
The anchor system doesn't work fine anymore. Why?
Now a shortcut href with an anchor crashes 'pid$>data>pid#'.
I've defered and included '-anchor', as a temporary solution.

The anchors management has to be explored. Do they better be apart of the href?
